...
const Timeline = () => {
	return (
		<div className='w-full flex bg-slate-900 h-screen '>
...
const CreateRoom = () => {
	return (
		<section className='w-full sm:px-4 md:px-8 '>
			<div className='p-4 bg-slate-800 rounded-md text-gray-300 flex justify-start items-center space-x-1  w-full'>
				...
				<div className='flex space-x-4 w-auto overflow-x-scroll scrollbar-hide'>
					{names.map((name, i) => (
						<div
							key={i}
